...
public class OrderServiceImplV4 implements OrderService {
	...
	public List<OrderInfo> findList() {
		...
		OrderInfo o1 = new OrderInfo(1L, "Tom", "笔记本", 12.5D, "4.0.0");
		OrderInfo o2 = new OrderInfo(2L, "Jack", "铅笔", 3.5D, "4.0.0");
		OrderInfo o3 = new OrderInfo(3L, "Lily", "橡皮", 5.0D, "4.0.0");
